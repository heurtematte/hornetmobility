...
Y.extend(Filtre, Y.Widget, {
    ...
    _afterVisibleChange : function(event) {
        Y.log('_afterVisibleChange called', 'info', Filtre.NAME);
    ...
    _afterActiveChange : function(event) {
        Y.log('_afterActiveChange called', 'info', Filtre.NAME);
    ...
    _defUpdateFn : function(event) {
        Y.log('_defUpdateFn called', 'info', Filtre.NAME);
    ...
    _onShowButtonClick : function(event) {
        Y.log('_onShowButtonClick called', 'info', Filtre.NAME);
        event.halt(true);
        if (this.get(VISIBLE)) {
            this.hide();
        } else {
    ...
    _onCloseButtonClick : function(event) {
        Y.log('_onCloseButtonClick called', 'info', Filtre.NAME);
        this.hide();
    },
    ...
    _onSubmitButtonClick : function(event) {
        Y.log('_onSubmitButtonClick called', 'info', Filtre.NAME);
        this.fire('update');
    },
    ...
    _onCancelButtonClick : function(event) {
        Y.log('_onCancelButtonClick called', 'info', Filtre.NAME);
        this.reset();
        this.hide();
    }
});
