...
function FieldCalendar(
		...
		/* object */	config)
{
	Y.log("constructor called", "info", FieldCalendar.NAME);
	config = config || {};
...
function convertFormat(format){
	...
	result = result.replace("mm", "%M");
    Y.log('convertFormat: ' + result, 'info', FieldCalendar.NAME);
	return result;
}

function parseDate(date, format){
    Y.log("parsing... '" + date + "' (format: '" + format + "')", 'info', FieldCalendar.NAME);
	var tmp, val,
	result = new Date(),
	str = format,
	dt = date;
    ...
    Y.log("parsed date: " + result, 'info', FieldCalendar.NAME);
	return result;
}
...
Y.extend(FieldCalendar, Y.Base,
{
	...
	{
		Y.log('initializer called', 'life', FieldCalendar.NAME);
	...
	destructor: function()
	{
		Y.log('destructor called', 'life', FieldCalendar.NAME);
	 ...
	 */
	hide: function () {
		Y.log("hide", "info", FieldCalendar.NAME);
	 ...
	 */
	show: function () {
		Y.log("show", "info", FieldCalendar.NAME);
	 ...
	 */
	reset: function () {
		Y.log("reset", "info", FieldCalendar.NAME);
	...
	_selectDate: function(fieldValue) {
		...
		Y.log("show date: '"+selDate+"' for selected date: '"+selection+"'", "info", FieldCalendar.NAME);
		
	},
	
	_createCalendar: function() {
		Y.log("create Calendar", "life", FieldCalendar.NAME);
	...
	_onSelect: function () {
		...
		Y.log("selected date: '"+fieldValue+"'", "info", FieldCalendar.NAME);
