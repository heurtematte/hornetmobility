...
Y.extend(Validator, Y.Base, {
    ...
    {
        Y.log('initializer called', 'life', Validator.NAME);
    },
    
    destructor: function()
    {
        Y.log('destructor called', 'life', Validator.NAME);
    },
    ...
    validate : function (f, elt) {
        Y.log('validate: false', 'info', Validator.NAME);
        return false;
    },
    ...
    setErrorMessage: function(
        /* string */    msg)
    {
        Y.log('setErrorMessage(\"' + msg + '\")', 'info', Validator.NAME);
    ...
    {
        Y.log('getErrorMessage', 'info', Validator.NAME);
